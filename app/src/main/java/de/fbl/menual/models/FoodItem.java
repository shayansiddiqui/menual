...
/**
 * Model for holding the fooditem attributes.
 */
public class FoodItem implements Serializable {
    /**
     * Displayable food item name
     */
    private String foodName;
    /**
     * red, yellow or green result of the food item
     */
    ...
    /**
     * Photo for displaying in the list view
     */
    private String lowResPhoto;
    private String highResPhoto;
    /**
     * Statistics labels obtained from the Evaluator
     */
    String[] statisticText;
    /**
     * Statistics values obtained from the Evaluator
     */
    ...
    /**
     *Creates a mock object for doing testing
     * @return FoodItem Mock object for doing testing
     */
